...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_identifier_list = 12            /* identifier_list  */
};
...
static const char *const yytname[] =
{
  ...
  "type", "identifier_list", YY_NULLPTR
};
...
#line 1225 "build/parser.tab.c"
  ...
  case 5: /* declaration: type identifier_list SEMICOLON  */
#line 61 "src/parser.y"
        ...
        Declaration *current = (yyvsp[-1].decl_list);
        while (current != NULL) {
        ...
        current = reversed;
        while (current != NULL) {
            add_declaration(current->identifier, (yyvsp[-2].str));
...
#line 94 "src/parser.y"
        ...
        (yyval.decl_list) = create_declaration_node((yyvsp[0].str), NULL);
        free((yyvsp[0].str));
    }
#line 1272 "build/parser.tab.c"
    break;
...
#line 99 "src/parser.y"
        ...
        Declaration *new_node = create_declaration_node((yyvsp[0].str), NULL);
        new_node->next = (yyvsp[-2].decl_list);
        (yyval.decl_list) = new_node;
        free((yyvsp[0].str));
    }
